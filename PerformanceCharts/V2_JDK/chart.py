...
valid_cols = [
    ...
    if col in jdk_df.columns and col != "Size"
]
...
print(f"Successfully generated {len(valid_cols)} performance graphs comparing V2 and JDK Stack in {script_dir}")