...
# Common columns to plot (excluding Size and intersection present in both)
exclude_cols = {"Size", "Winner"}
v2_methods = [col for col in v2_df.columns if col not in exclude_cols]
v1_methods = [col for col in v1_df.columns if col not in exclude_cols]
valid_cols = [col for col in v2_methods if col in v1_methods]

# ---------------------------------------------------------------------------
# Plotting
# ---------------------------------------------------------------------------
color_v2 = "#ff4d4d"  # Red for CustomStack V2
color_v1 = "#4da6ff"  # Blue for CustomStack V1
...
for method in valid_cols:
    ...
    legend_elements = [
        Line2D(
            ...
            color="none",
            label="V1",
            markerfacecolor=color_v1,
            markeredgecolor=color_v1,
            markersize=8,
            linestyle="None",
        ),
        Line2D(
            ...
            color="none",
            label="V2",
            markerfacecolor=color_v2,
            markeredgecolor=color_v2,
            markersize=8,
            linestyle="None",
        ),
    ]
...
print(f"Successfully generated {len(valid_cols)} V2 vs V1 performance graphs in {script_dir}")